...
const StyledSidebar = (props) => {
    return (
        <div className={`${props.deviceHidden ? "lg-max:hidden" :"lg:hidden"} flex lg:sticky lg:top-20 lg:h-[calc(100vh-5rem)] lg:w-[400px] bg-white dark:bg-green-800 dark:text-lime-50 lg:px-5 lg:pt-8`}>
